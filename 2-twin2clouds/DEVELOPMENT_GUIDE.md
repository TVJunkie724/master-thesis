...
| Property | Value |
|----------|-------|
| **Container Name** | `master-thesis-2twin2clouds-1` |
| **Host Path** | `d:\Git\master-thesis\2-twin2clouds` |
| **Container Path** | `/app` |
...
```bash
docker exec -e PYTHONPATH=/app master-thesis-2twin2clouds-1 python rest_api.py
```
