...
| [#115](https://github.com/TVJunkie724/master-thesis/issues/115) | In progress | Separate public TwinMaker Price List evidence from owner-scoped account plan observations; gate Basic, pending changes, and unallocated bundles before AWS L4 selection |
| [#119](https://github.com/TVJunkie724/master-thesis/issues/119) | Planned pre-Phase-8 blocker | Replace mutable provider-wide pricing files with immutable provider-and-region keyed catalog snapshots before route-aware transfer pricing |
