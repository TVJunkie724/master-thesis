...
| Issue | Status | Notes |
|-------|--------|-------|
| [#6](https://github.com/TVJunkie724/master-thesis/issues/6) | Active | CloudConnection credential SSOT and Compose split. Slices 2-3 implemented (`.secrets/local/` local-cloud override, CloudConnection-based seeding). Plan: [`docs/plans/2026-05-19_credential_ssot_compose_split.md`](https://github.com/TVJunkie724/master-thesis/blob/master/docs/plans/2026-05-19_credential_ssot_compose_split.md) |
