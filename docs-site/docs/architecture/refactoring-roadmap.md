...
| [#119](https://github.com/TVJunkie724/master-thesis/issues/119) | Implementation in progress | Replace mutable provider-wide pricing files with durable, immutable provider-and-region keyed catalog snapshots before route-aware transfer pricing. Reviewed plan: `2-twin2clouds/implementation_plans/2026-07-17_immutable_region_pricing_catalogs.md` |
