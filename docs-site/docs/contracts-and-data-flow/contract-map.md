...
flowchart TB
    ...
    Optimizer -->|"Calculation response<br/>cost, traces, path, specification,<br/>dark resolved architecture, capabilities"| Management
