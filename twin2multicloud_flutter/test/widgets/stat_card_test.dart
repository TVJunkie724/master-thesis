...
void main() {
  ...
  group('StatCard', () {
    ...
    testWidgets('displays icon correctly', (tester) async {
      await tester.pumpWidget(
        buildTestWidget(title: 'Devices', value: '100', icon: Icons.devices),
      );
    ...
    testWidgets('handles empty value', (tester) async {
      await tester.pumpWidget(
        buildTestWidget(title: 'Empty', value: '', icon: Icons.warning),
      );
    ...
    testWidgets('renders in Card container', (tester) async {
      await tester.pumpWidget(
        buildTestWidget(title: 'Test', value: '42', icon: Icons.info),
      );
