...
void main() {
  ...
  group('LayerCostCard', () {
    ...
    testWidgets('renders layer title', (tester) async {
      await tester.pumpWidget(buildTestWidget(layer: 'L1 - Data Ingestion'));
    ...
    testWidgets('shows "Includes Glue Code" badge for dispatcher', (
      tester,
    ) async {
    ...
    group('L3 storage tiers', () {
      testWidgets('correctly identifies L3_hot from cheapest path', (
        tester,
      ) async {
