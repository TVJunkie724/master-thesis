...
class MockApiService {
  ...
  Future<Map<String, dynamic>> Function(String, {String? name, String? state})?
  updateTwinResponse;
  ...
  updateTwinConfigResponse;

  // Credentials
  Future<Map<String, dynamic>> Function(String, String)?
  validateCredentialsResponse;
  Future<Map<String, dynamic>> Function(String, Map<String, dynamic>)?
  validateCredentialsInlineResponse;
  Future<Map<String, dynamic>> Function(String, Map<String, dynamic>)?
  validateCredentialsDualResponse;
  Future<Map<String, dynamic>> Function(String, String)?
  validateStoredCredentialsDualResponse;
  ...
  Future<Map<String, dynamic>> Function(String, Map<String, dynamic>)?
  updateDeployerConfigResponse;
  Future<Map<String, dynamic>> Function(String, String, String)?
  validateDeployerConfigResponse;
  Future<Map<String, dynamic>> Function(String, String, String, String)?
  validateL2ContentResponse;
  Future<Map<String, dynamic>> Function(String, String, String, String)?
  validateL4ContentResponse;
  Future<Map<String, dynamic>> Function(String, String, String, String)?
  validateL5ContentResponse;

  // Result wrappers
  Future<Result<CalcResult>> Function(Map<String, dynamic>)?
  calculateCostsResultResponse;
  Future<Result<Map<String, dynamic>>> Function()?
  getPricingStatusResultResponse;
  Future<Result<Map<String, dynamic>>> Function(String)?
  getTwinConfigResultResponse;
  ...
  Future<Map<String, dynamic>> getDashboardStats() async {
    return _maybeThrow('getDashboardStats', () async {
      if (getDashboardStatsResponse != null) {
  ...
  Future<Map<String, dynamic>> calculateCosts(
    ...
    return _maybeThrow('calculateCosts', () async {
      ...
      if (calculateCostsResponse != null) {
        return calculateCostsResponse!(params);
      }
      return {
        'result': {
          'awsCosts': {
  ...
  Future<Map<String, dynamic>> getOptimizerConfig(String twinId) async {
    return _maybeThrow('getOptimizerConfig', () async {
      ...
      if (getOptimizerConfigResponse != null) {
        return getOptimizerConfigResponse!(twinId);
      }
  ...
  Future<Map<String, dynamic>> exportPricing(String provider) async {
    return _maybeThrow('exportPricing', () async {
      ...
      if (exportPricingResponse != null) {
        return exportPricingResponse!(provider);
      }
      return {'data': {}};
    });
  }
  ...
  Future<Map<String, dynamic>> getDeployerConfig(String twinId) async {
    return _maybeThrow('getDeployerConfig', () async {
      ...
      if (getDeployerConfigResponse != null) {
        return getDeployerConfigResponse!(twinId);
      }
      return {
        'twin_id': twinId,
        'config_json': null,
  ...
  // Zip Upload
  Future<Map<String, dynamic>> Function(String, List<int>, String)?
  ...
  Future<Map<String, dynamic>> uploadProjectZip(
    ...
    return _maybeThrow('uploadProjectZip', () async {
      _trackCall('uploadProjectZip', [twinId, fileName]);
      if (uploadProjectZipResponse != null) {
        return uploadProjectZipResponse!(twinId, fileBytes, fileName);
      }
      // Default successful extraction response
      return {
        'success': true,
        'files': {
          'config_events.json': {'exists': true, 'content': '[]'},
          'config_iot_devices.json': {'exists': true, 'content': '[]'},
        },
        'functions': {
          'processors': {},
          'event_actions': {},
