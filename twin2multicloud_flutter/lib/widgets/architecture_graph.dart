...
class _ArchitectureGraphState extends State<ArchitectureGraph> {
          ...
          child: Column(
            children: [
              ...
              _buildLayerCard('L4', 'Digital Twin', layers['L4'], [
                _buildEditableComponentBox(
                  _getL4Service(layers['L4']),
                  Icons.hub,
                ),
              ], isEditable: true),
              _buildArrow(),
                            ...
                            Row(
                              ...
                              children: [
                                if (hasFeedback) ...[
                                  Column(
                                    children: [
                                      _buildEditableComponentBoxSmall(
                                        'Feedback',
                                        Icons.replay,
                                      ),
                                      const SizedBox(height: 4),
        ...
        children: [
          ...
          Column(
            children: [
              ...
              _buildStorageBox(
                'Hot',
                _getL3HotService(layers['L3_hot']),
                layers['L3_hot'],
              ),
              _buildArrow(small: true),
              _buildStorageBox(
                'Cool',
                _getL3CoolService(layers['L3_cool']),
                layers['L3_cool'],
              ),
              _buildArrow(small: true),
              _buildStorageBox(
                'Archive',
                _getL3ArchiveService(layers['L3_archive']),
                layers['L3_archive'],
              ),
            ],
          ),
          ...
          if (hasCrossToL4) ...[
            ...
            Column(
              children: [
                ...
                if (hasCrossFromL2)
                  const SizedBox(height: 60), // Height of Hot Writer + arrow
                Row(
                  children: [
                    Icon(
                      Icons.arrow_forward,
  ...
  Widget _buildEditableSourceBox(String name, IconData icon) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: editableColor.withAlpha(30),
            blurRadius: 6,
          ...
          Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 10,
                  color: editableColor.withAlpha(180),
                ),
              ),
            ],
          ),
  ...
  String _getL1Service(String? p) => switch (p?.toUpperCase()) {
    'AWS' => 'IoT Core',
    'AZURE' => 'IoT Hub',
    'GCP' => 'Pub/Sub',
    _ => 'IoT',
  };
  String _getL3HotService(String? p) => switch (p?.toUpperCase()) {
    'AWS' => 'DynamoDB',
    'AZURE' => 'Cosmos DB',
    'GCP' => 'Firestore',
    _ => 'Hot',
  };
  String _getL3CoolService(String? p) => switch (p?.toUpperCase()) {
    'AWS' => 'S3 IA',
    'AZURE' => 'Blob Cool',
    'GCP' => 'Nearline',
    _ => 'Cool',
  };
  String _getL3ArchiveService(String? p) => switch (p?.toUpperCase()) {
    'AWS' => 'Glacier',
    'AZURE' => 'Archive',
    'GCP' => 'Coldline',
    _ => 'Archive',
  };
  String _getL4Service(String? p) => switch (p?.toUpperCase()) {
    'AWS' => 'TwinMaker',
    'AZURE' => 'ADT',
    _ => 'Twin',
  };
