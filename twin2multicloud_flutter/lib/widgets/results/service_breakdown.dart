...
class ServiceBreakdown extends StatelessWidget {
  ...
  const ServiceBreakdown({super.key, required this.result});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        _buildLayerAccordion(
          context,
          'Layer 1: Data Acquisition',
          result.awsCosts.l1,
          result.azureCosts.l1,
          result.gcpCosts.l1,
        ),
        _buildLayerAccordion(
          context,
          ...
          result.awsCosts.l2,
          result.azureCosts.l2,
          result.gcpCosts.l2,
        ),
        _buildLayerAccordion(
          context,
          'Layer 3: Hot Storage',
          result.awsCosts.l3Hot,
          result.azureCosts.l3Hot,
          result.gcpCosts.l3Hot,
        ),
        _buildLayerAccordion(
          context,
          'Layer 3: Cool Storage',
          result.awsCosts.l3Cool,
          result.azureCosts.l3Cool,
          result.gcpCosts.l3Cool,
        ),
        _buildLayerAccordion(
          context,
          'Layer 3: Archive Storage',
          result.awsCosts.l3Archive,
          result.azureCosts.l3Archive,
          result.gcpCosts.l3Archive,
        ),
        _buildLayerAccordion(
          context,
          'Layer 4: Twin Management',
          result.awsCosts.l4,
          result.azureCosts.l4,
          result.gcpCosts.l4,
        ),
        _buildLayerAccordion(
          context,
  ...
  Widget _buildLayerAccordion(
    ...
    bool hasData =
        (aws?.components.isNotEmpty ?? false) ||
