...
class ArchitectureServiceMap {
  ...
  static String getL4Service(String? provider) {
    switch (provider?.toUpperCase()) {
      case 'AWS':
        return 'IoT TwinMaker';
      case 'AZURE':
        return 'Azure Digital Twins';
      case 'GCP':
        return 'Custom DT';
      default:
        return 'Digital Twin';
  ...
  static Color getProviderColor(String? provider, {bool isDark = false}) {
    switch (provider?.toUpperCase()) {
      case 'AWS':
        return AppColors.aws;
      case 'AZURE':
        return AppColors.azure;
      case 'GCP':
        return AppColors.gcp;
      default:
        return isDark ? Colors.grey.shade400 : Colors.grey.shade600;
    }
  }

  static Color getProviderBackgroundColor(
    String? provider, {
    bool isDark = false,
  }) {
  ...
  static String? extractProviderFromSegment(String segment) {
    return ArchitecturePath.providerForSegment(segment);
  }
