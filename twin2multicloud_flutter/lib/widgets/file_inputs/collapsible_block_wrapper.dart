...
class CollapsibleBlockWrapper extends StatefulWidget {
  ...
  @override
  State<CollapsibleBlockWrapper> createState() =>
      _CollapsibleBlockWrapperState();
}
...
class _CollapsibleBlockWrapperState extends State<CollapsibleBlockWrapper> {
  ...
  @override
  void didUpdateWidget(CollapsibleBlockWrapper oldWidget) {
    super.didUpdateWidget(oldWidget);
    // If forceCollapsed becomes true, collapse the block
