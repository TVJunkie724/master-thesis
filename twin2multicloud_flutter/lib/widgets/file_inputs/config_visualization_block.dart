...
class ConfigVisualizationBlock extends StatelessWidget {
      ...
      children: [
        ...
        LayoutBuilder(
          builder: (context, constraints) {
            final jsonPanel = _buildJsonPanel();
            ...
            return Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Expanded(flex: 2, child: jsonPanel),
  ...
  static Widget buildProvidersVisual(Map<String, String> layerProviders) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        ...layerProviders.entries.map(
          (e) => _buildLayerProviderRow(e.key, e.value),
        ),
      ],
    );
  }
  ...
  static String _layerDisplayName(String key) {
    switch (key) {
      case 'layer_1_provider':
        return 'L1 Ingestion';
      case 'layer_2_provider':
        return 'L2 Processing';
      case 'layer_3_hot_provider':
        return 'L3 Hot Storage';
      case 'layer_3_cold_provider':
        return 'L3 Cold Storage';
      case 'layer_3_archive_provider':
        return 'L3 Archive';
      case 'layer_4_provider':
        return 'L4 Twin Mgmt';
      case 'layer_5_provider':
        return 'L5 Visualization';
      default:
        return key;
    }
  }
  ...
  static String _featureDisplayName(String key) {
    switch (key) {
      case 'useEventChecking':
        return 'Event Checking';
      case 'triggerNotificationWorkflow':
        return 'Workflows';
      case 'returnFeedbackToDevice':
        return 'Device Feedback';
