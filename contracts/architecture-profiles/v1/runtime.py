...
SCHEMA_FILES = {
    "architecture-profile.v1": "architecture-profile.schema.json",
    "provider-implementation-profile.v1": (
        "provider-implementation-profile.schema.json"
    ),
    "deployment-component-catalog.v1": ("deployment-component-catalog.schema.json"),
    "resolved-twin-architecture.v1": ("resolved-twin-architecture.schema.json"),
    "semantic-registry.v1": "semantic-registry.schema.json",
}
...
def _check_semantic_registry(document: Mapping[str, Any]) -> None:
    ...
    expected_definition_owners = {
        ...
        ("provider-implementation-profile.v1", "/"),
        ("deployment-component-catalog.v1", "/"),
    }
    ...
    if ownership.get(("resolved-twin-architecture.v1", "/calculation_run_id")) != (
    ...
    optimizer_owned = {
        ...
        if contract_kind == "resolved-twin-architecture.v1"
...
def _check_provider_profile(
    ...
    profiles = linked.get("architecture-profile.v1", [])
    ...
    catalogs = linked.get("deployment-component-catalog.v1", [])
    if not catalogs:
        return
...
def _validate_document_impl(
    ...
    *,
    ...
    if schema_version == "architecture-profile.v1":
        _check_profile(mutable, semantic_registry)
    elif schema_version == "provider-implementation-profile.v1":
        _check_provider_profile(mutable, linked)
    elif schema_version == "deployment-component-catalog.v1":
        _check_catalog(mutable, linked)
    elif schema_version == "resolved-twin-architecture.v1":
        _check_resolved(mutable, linked, semantic_registry)
    elif schema_version == "semantic-registry.v1":
...
def validation_log_record(
    ...
    *,
    ...
    identity_fields = {
        "architecture-profile.v1": ("profile_id", "profile_version"),
        "provider-implementation-profile.v1": (
            "implementation_profile_id",
            "implementation_profile_version",
        ),
        "deployment-component-catalog.v1": ("catalog_id", "catalog_version"),
        "resolved-twin-architecture.v1": ("resolution_id", None),
        "semantic-registry.v1": ("registry_id", "registry_version"),
    }
