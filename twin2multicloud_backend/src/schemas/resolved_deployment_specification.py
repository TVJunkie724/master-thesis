...
DeploymentCompatibilityStatus = Literal["ready", "unavailable"]
...
class ResolvedDeploymentComponentSelectionV2(BaseModel):
    ...
    implementation_component_digest: str = Field(pattern=r"^sha256:[0-9a-f]{64}$")
    provider: Literal["aws", "azure", "gcp"]
...
ResolvedDeploymentSpecificationDocument = ResolvedDeploymentSpecificationV2
