...
@dataclass(frozen=True, slots=True)
class ValidatedSixLayerCostLedger:
    ledger: dict[str, Any]
...
def validate_six_layer_cost_ledger(
    raw_ledger: object,
    *,
    ...
    if ledger["schema_version"] != "six-layer-cost-ledger.v1":
    ...
    return ValidatedSixLayerCostLedger(
        ledger=ledger,
