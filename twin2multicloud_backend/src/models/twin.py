...
class DigitalTwin(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "name", name="uq_user_twin_name"),)
    ...
    configuration = relationship(
        "TwinConfiguration", back_populates="twin", uselist=False
    )
    ...
    deployment_logs = relationship(
        "DeploymentLog", back_populates="twin", order_by="DeploymentLog.event_id.asc()"
    )
    ...
    user_functions = relationship(
        "TwinUserFunction",
        back_populates="twin",
        cascade="all, delete-orphan",
        order_by="TwinUserFunction.slot_id.asc()",
    )
