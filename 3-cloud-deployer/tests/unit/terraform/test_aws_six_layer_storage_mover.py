"""Pure contract tests for the finite AWS Six-layer storage mover."""
...
SOURCE = (
    ...
    / "src/providers/aws/lambda_functions/six-layer-domain/storage-mover/storage_mover.py"
)
SPEC = importlib.util.spec_from_file_location("aws_six_layer_storage_mover", SOURCE)
