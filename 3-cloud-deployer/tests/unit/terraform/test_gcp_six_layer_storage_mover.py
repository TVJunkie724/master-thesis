"""Pure contract tests for the finite GCP Six-layer storage mover."""
...
SOURCE = (
    ...
    / "src/providers/gcp/containers/six-layer-domain/storage-mover/storage_mover.py"
)
SPEC = importlib.util.spec_from_file_location("gcp_six_layer_storage_mover", SOURCE)
