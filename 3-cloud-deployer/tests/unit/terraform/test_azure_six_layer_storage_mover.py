"""Pure contract tests for the finite Azure Six-layer storage mover."""
...
SOURCE = (
    ...
    / "src/providers/azure/azure_functions/six-layer-domain/storage-mover/storage_mover.py"
)
SPEC = importlib.util.spec_from_file_location("azure_six_layer_storage_mover", SOURCE)
