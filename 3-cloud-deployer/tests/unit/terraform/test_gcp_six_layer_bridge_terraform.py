"""Closed Terraform bindings for the standalone GCP Six-layer source bridge."""
...
def test_gcp_to_aws_trusts_exact_route_aware_publish_targets():
    ...
    assert "Resource = local.gcp_six_layer_bridge_aws_telemetry_targets" in source
    assert "Resource = local.gcp_six_layer_bridge_aws_control_targets" in source
