...
locals {
  ...
  l0_aws_enabled = local.aws_enabled && !local.six_layer_enabled && (
  ...
  l0_ingestion_enabled      = !local.six_layer_enabled && var.layer_1_provider != "aws" && var.layer_2_provider == "aws"
  l0_hot_writer_enabled     = !local.six_layer_enabled && var.layer_2_provider != "aws" && var.layer_3_hot_provider == "aws"
  l0_hot_reader_enabled     = !local.six_layer_enabled && var.layer_3_hot_provider == "aws" && var.layer_4_provider != "aws"
  l0_cold_writer_enabled    = !local.six_layer_enabled && var.layer_3_hot_provider != "aws" && var.layer_3_cold_provider == "aws"
  l0_archive_writer_enabled = !local.six_layer_enabled && var.layer_3_cold_provider != "aws" && var.layer_3_archive_provider == "aws"
