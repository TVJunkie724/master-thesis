...
def _deploy_function_code_via_kudu(
    ...
    Includes retry logic to handle the case where Kudu SCM site
    isn't ready immediately after Function App creation.
    ...
    Raises:
        HttpResponseError: If Kudu deployment fails after retries
    """
