...
| 1 | In progress | [PHASE_01_MANAGEMENT_API_AUDIT.md](phases/PHASE_01_MANAGEMENT_API_AUDIT.md) | Management API route/service/persistence boundary audit and refactor plan. |
