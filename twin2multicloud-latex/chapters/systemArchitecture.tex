...
Raw-history queries remain provider-local because the profile requires hot
storage and visualization to be co-located. This constraint is enforced during
candidate enumeration. The other three contracts have explicit directed
AWS/Azure/GCP route implementations with source-owned transfer, bridge,
identity, retry, and cost attribution.
